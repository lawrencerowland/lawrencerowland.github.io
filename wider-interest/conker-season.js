...
function swing(hard=false){
 ...
 else if(attacking){const force=hard?3:2;o.hp-=force;if(hard)c.hp-=2;else if(roll===3)c.hp--;text=hard?'A heavy crack. More force, but wear on your own nut too.':'A clean knock. Their shell takes the blow.';}
